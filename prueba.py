...
while not salir:
    ...
    match opcion_menu:
        ...
        case "2":
            if not lista_de_nombres:
                ...
                for i, nombre_completo in enumerate(lista_de_nombres, start=1):
                    print(f"{i}. {nombre_completo[0]} {nombre_completo[1]} {nombre_completo[2]}")
        ...
        case "3":
            ...
            table.add_column("Fecha", justify="center", style="turquoise4", no_wrap=True)
            ...
            for i, nombre_completo in enumerate(
                ...
                table.add_row(f"{i}", f"{nombre_completo[0]}", f"{nombre_completo[2]}", f"{nombre_completo[1]}")
